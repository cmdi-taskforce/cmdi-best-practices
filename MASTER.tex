...
%inline notes (todos, notes and editors only in draft)
...
\newcommandx{\editor}[2][1=]{\ifthenelse{\boolean{bpdraft}}{\todo[inline,linecolor=pink,backgroundcolor=pink!25,bordercolor=pink,#1]{Editor: #2}}{}}
