...
group ``recommended'' and can be displayed in the standard component registry. \bptodo{TODO: For a similar reason it is advised to compare a new design with recommended profiles [Alex]}
\end{workinprogress}
