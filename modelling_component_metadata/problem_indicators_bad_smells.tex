...
\todo{Move (most of) these general remarks (``(Bad) Smells are often called refactorings'') to the ``How to use this Guide'' section? And replace with a brief reference to how to use}
