...
\label{cs3}
\bptodo{Split in (1) use english (=translate description, perhaps also title), (2) specify language (synchronise with common approaches). Factor in use of vocabularies}
...
\bptodo{Separate best practice on not using string concatenation for multi-valued content. Old smell covering this: 
