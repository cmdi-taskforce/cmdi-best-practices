...
\note{Menzo: I'll see if I can create a schematron rule for this (will need an extension to do a HEAD request and get the content-type response field)}
